  ...
  <body>
    ...
    <div class="page text-center">
      <div class="bg-image-03 context-dark page-wide">
        <!-- Page Header-->
        <header><a href="index.html" class="reveal-inline-block brand-name"><img src="assets/images/logo-white.png" width="166" height="55" alt="" class="img-responsive center-block"></a></header>
        <!-- Page Content-->
        <main class="page-content page-content-100">
          <div class="page-content-inner">
            <div class="shell">
              <h1 class="text-ubold"><span class="big">404</span></h1>
              <h3 class="offset-top-20 text-ubold">Sorry, But the Page Was Not Found</h3>
              <p style="opacity: .5;" class="offset-top-30 big">You may have mistyped the address or the page may have moved.</p><a href="./" class="offset-top-60 btn btn-primary btn-naira btn-naira-up"><span class="icon mdi mdi-arrow-left-bold"></span><span>back to home page</span></a>
            </div>
          </div>
        </main>
        <!-- Page Footer-->
